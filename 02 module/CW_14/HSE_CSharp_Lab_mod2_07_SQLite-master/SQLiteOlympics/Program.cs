...
namespace SQLPrac
{
    ...
    class Program
    {
        ...
        private static string task01 = "SELECT c.name, c.area_sqkm FROM Countries c WHERE c.area_sqkm>1000000";
        private static string task02 = "SELECT * FROM Olympics o JOIN Countries c ON o.country_id = c.country_id";
        private static string task03 = "SELECT name FROM Players WHERE name LIKE 'Mi%'";
        private static string task04 = "SELECT * FROM Events e JOIN Olympics o ON e.olympic_id = o.olympic_id WHERE o.year=2000";
        ...
        private static string task06 = "SELECT * FROM Results r " +
            "JOIN Players p ON p.player_id=r.player_id " +
